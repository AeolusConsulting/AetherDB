...
impl OllamaProvider {
    pub fn new(base_url: &str, model: &str, dim: u16) -> Self {
        OllamaProvider {
...
impl EmbeddingProvider for OllamaProvider {
    ...
    async fn embed(&self, texts: &[String]) -> Result<Vec<Vec<f32>>, ProviderError> {
        ...
        let data = json
            ...
            .ok_or_else(|| ProviderError::Retryable("missing 'data' array in response".into()))?;
        ...
        for item in data {
            let embedding = item
                ...
                .ok_or_else(|| {
                    ProviderError::Retryable("missing 'embedding' in data item".into())
                })?;
